...
<div class={`flex flex-row flex-grow h-full w-full`}>
    <div
        class={`${fmt_trellis(hide_border_b, hide_border_t)} flex flex-row h-line w-full justify-start items-center border-t-line border-ly${layer}-edge overflow-hidden`}
    >
