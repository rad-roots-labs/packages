<script lang="ts">
    import ButtonSimple from "$lib/components/buttons/button-simple.svelte";
    ...
    import type { IViewBasis, IViewFarmsDetailsData } from "$lib/types/views";
    import {
        Flex,
        get_context,
        Glyph,
        ...
        >
            ...
            >
                <div class={`flex flex-col w-full justify-start items-center`}>
                    ...
                    >
                        <p
                            class={`font-sans font-[500] text-lg text-ly0-gl tracking-tight`}
                        >
            ...
            >
                <div
                    class={`flex flex-col h-full w-full p-4 gap-4 justify-start items-center bg-ly1 rounded-2xl`}
                >
                    <p class={`font-sans font-[500] text-sm text-ly0-gl`}>
                        {`Farm Info`}
                    </p>
                    <div
                    ...
                    >
                        ...
                        >
                            ...
                            {:else}
                                ...
                                >
                                    <p
                                        class={`font-sans font-[400] text-ly0-gl_pl`}
                                    >
                                        {`Add`}
                                    </p>
                                    <Glyph
                                        basis={{
                                            classes: `text-ly0-gl_pl`,
                                            dim: `xs`,
                                            key: `caret-right`,
                                        }}
                                    />
