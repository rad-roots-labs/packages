import type {
    ...
    GeolocationAddress,
    GeolocationLatitudeFmtOption,
    GeometryPoint,
} from "./types.js";
import { parse_geocode_address } from "./parse.js";
...
export const fmt_geometry_point_coords = (
    point: GeometryPoint,
    locale: string
): string => {
...
export const geol_lat_fmt = (
    lat: number,
    fmt_opt: GeolocationLatitudeFmtOption,
    locale: string,
    precision: number = 5
): string => {
